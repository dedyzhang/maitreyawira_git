...
@section('container')
    <div class="p-4 bg-white rounded-lg shadow-md">
        ...
        <div class="mt-10">
            <a class="button-d bg-blue-400 hover:bg-blue-600 focus:ring-blue-400 w-full block sm:inline sm:w-auto mb-1" href="{{ route('spmb.daftar',$sekolah->uuid) }}">Tambah Siswa</a>
