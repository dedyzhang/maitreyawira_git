...
@section('container')
    <div class="p-4 bg-white rounded-lg shadow-md">
        <h1 class="text-2xl font-bold">INTERVIEW SPMB</h1>
        <p class="text-gray-600 italic">Halaman untuk mengatur data INTERVIEW SPMB</p>
            ...
            @foreach ($sekolah as $item)
                <div class="col-span-4 sm:col-span-4 md:col-span-2 lg:col-span-1 xl:col-span-1 flex justify-center">
                    <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow-sm">
                        ...
                        <a href="{{ route('spmb.interview.show',$item->uuid) }}" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center cursor-pointer">Lihat Interview</a>
                    </div>
                </div>
            @endforeach
        </div>
