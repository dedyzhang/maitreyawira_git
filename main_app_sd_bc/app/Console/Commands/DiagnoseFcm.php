...
class DiagnoseFcm extends Command
{
    ...
    public function handle(): int
    {
        ...
        $this->warn('  → COCOKKAN project_id di atas dengan project Firebase yang dipakai APK Android (google-services.json) UNTUK APP INI. Kalau beda, token dari APK itu TIDAK akan valid untuk kredensial ini walau .env & file JSON-nya persis sama dengan hosting lain.');
        ...
        if (!$tokenModel) {
            ...
            if ($total === 0) {
                ...
                $recent = $tokenModel::latest('updated_at')->first();
