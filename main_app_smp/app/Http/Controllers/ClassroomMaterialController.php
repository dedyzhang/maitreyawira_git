...
class ClassroomMaterialController extends Controller implements \Illuminate\Routing\Controllers\HasMiddleware
{
    ...
    public function show(Request $request, ClassroomMaterial $material)
    {
        ...
        // Materi terkunci â†’ siswa harus buka token dulu (kecuali guru/admin pengelola).
    ...
    /** Tampilkan file (gambar/PDF) inline di modal tanpa pindah halaman â€” dibutuhkan utk materi terkunci (layar penuh). */
    ...
    /**
     * Satu materi bisa ditaut ke BANYAK kelas sekaligus (classroom_material_links) â€” kelas
     ...
     * â€” cari dulu kelas yg ditaut & relevan ke user ini, baru fallback ke kelas asal kalau
    ...
    // â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ Materi terkunci (token + layar penuh) â€” via HandlesContentLock â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    public function closeMeet(Request $request, ClassroomMaterial $material)
    {
        ...
        return back()->with('success', 'Kelas online ditutup â€” link Google Meet dihapus.');
    }

    /** Normalisasi input Google Meet (URL penuh atau kode xxx-xxxx-xxx) â†’ URL bersih. */
     ...
     * kelas yang ia ampu sendiri. Mis. dari Matematika 7A â†’ hanya 7B/7C/7D.
     */
